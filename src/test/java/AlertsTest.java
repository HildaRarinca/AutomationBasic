...
public class AlertsTest {
    ...
    public void AlertsTest(){
        ...
        interactWithPromptButtonAlert("Hilda");
    ...
    public void interactWithPromptButtonAlert(String alertvalue){
        ...
        assertTrue(resultText.getText().contains(alertvalue),"The result doesn't contain conatain the expected name." + resultText.getText());
